...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Account created successfully! Welcome to RealEstate DApp!');
      navigate('/properties');
    } catch (error) {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join thousands of investors in fractional real estate
          </p>
        </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-50 text-gray-500">
                  Note: Connect your wallet later to trade and invest
                </span>
              </div>
            </div>
          </div>
